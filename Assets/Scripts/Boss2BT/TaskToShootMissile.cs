...
namespace Boss2AI{
public class TaskToShootMissile : Node{
    ...
    public TaskToShootMissile(Transform transform,GameObject bulletPrefab, Transform[] shootpoints){
    ...
    public override NodeState Evaluate()
    {
        ...
        if( Boss2BT.amountShoot<=0){
            Debug.Log("End of SP1");
            Boss2BT.SP1Ready = false; 
        }
